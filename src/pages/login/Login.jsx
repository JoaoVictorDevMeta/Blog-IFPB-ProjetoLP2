  ...
  const userLogin = async (data) => {
    ...
    try {
      ...
      if (!e?.code) {
        ...
        setMailMsg(
          'Um email foi enviando para sua conta, por favor verifique!',
        );
      ...
      <div className="login-form login p-5 text-center d-flex justify-content-center">
        {loading ? (
          ...
          >
            ...
            {mailMsg && <div className="alert alert-success">{mailMsg}</div>}

            <Button
              type="outline"
              className="btn button-outline mx-5 fs-4 mb-3"
            >
              Logar
            </Button>
          </form>
