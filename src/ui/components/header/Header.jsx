...
const Navbar = () => {
  ...
  return (
    <header className="d-flex flex-wrap py-4">
      ...
      <nav
        className={
          'navbar navbar-expand-lg navbar-light bg-none pb-4 px-5 justify-content-between gap-5 ' +
          (menu && 'menu-open')
        }
      >
        ...
        >
          ...
          />
          <Button type="outline">Buscar</Button>
        </form>
        {user ? (
          <div>
            ...
            <div
              className={
                'popover position-absolute ' + (popover ? '' : 'd-none')
              }
            >
              <div className="popover-content p-4">
                <Link to="/profile/1" className="nav-link mb-4">
                  Perfil
                </Link>
